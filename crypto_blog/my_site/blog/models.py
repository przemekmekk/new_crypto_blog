...
class Post(models.Model):
    ...
    twitter_itr_description = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
    twitter_href_1 = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
    twitter_pic = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
    twitter_nick = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
    twitter_href_2 = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
    twitter_date = models.TextField(validators=[MinLengthValidator(0)], null=True, blank=True)
